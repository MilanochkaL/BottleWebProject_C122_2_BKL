        ...
        <h1 class="center">Поиск в графе вершин, имеющих наибольшее окружение</h1>
            ...
            <div class="theory">
             ...
             <div class ="theory2">
                     ...
                     <img src="static/images/reachability_formula.png" width="420" height="90">
            ...
            <div class="theory">
                ...
                <img src="static/images/adjacency_matrix_formula.png" width="450" height="100">
                <p>Для матрицы смежности n(p,q) = О(р²).</p>
            </div>
            <div class ="theory2">
                <label>Пример:</label>
                <img src="static/images/adjacency_matrix.png" width="450" height="120">
